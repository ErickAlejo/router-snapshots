...
class Routers(Base):
    ...
    def __repr__(self) -> str:
        return f"'id': {self.router_id} alias: {self.router_alias} ip: {self.router_ip} vendor: {self.router_vendor} model: {self.router_model}"
...
class Output(Base):
    ...
    output_text: Mapped[str] = mapped_column(unique=True)
